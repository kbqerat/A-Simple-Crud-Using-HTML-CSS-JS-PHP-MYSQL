...
$sql = "select * from `guides_autre` where id='$selectedId'";
...
if (isset($_POST['submit'])) {
    ...
    $Min = $_POST['Min'];
    $Guides = $_POST['Guides'];
    $sql = "update `guides_autre` set id='$Id', GUIDES_TYPES='$Type', peremption='$Peremption', GUIDES_Quantite='$Quantite', min='$Min', GUIDES='$Guides' where id=$selectedId";
    $result = mysqli_query($con, $sql);
    if ($result) {
        header("location:../all-materials/display.php?item=40");
    } else {
